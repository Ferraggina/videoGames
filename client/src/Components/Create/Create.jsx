...
import { postgames, getGenres } from "../../Redux/Actions";
...
function validate(input) {
  ...
  if (!input.rating || input.rating > 5 || input.rating < 1) {
    errors.rating = "Rating debe ser entre 1 y 5!";
  }
      ...
      <div>
          ...
          <div>
            <div>
              ...
              <div className="form_inputs">
                ...
                />
                {errors.release && (
                  <p className="errorcito">{errors.release}</p>
                )}
              </div>
              <div className="form_inputs">
                <label>Rating </label>
        ...
        <div className="conteiner remove">
          ...
          {input.platforms.map((el) => (
            <div key={el} className="cardRemove">
